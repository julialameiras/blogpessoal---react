...
//estado que vai guardar a confirmaçao da senha
const [confirmaSenha, setConfirmaSenha] = useState<string>("");

//estado que vai indicar quando a animaçao (loader) será carregada
...
//funçao que atualiza as propriedades do Estado usuario
